...
const NULLABLE_OPTIONAL: ReadonlyMap<string, Reason> = new Map([
  ...
  ["fulfillments.destinations[].exchange", "array-member-uncensusable"],
  ...
  ["invoices.destinations[].exchange", "array-member-uncensusable"],
  ["invoices.items[].coa_revenue", "array-member-uncensusable"],
  ["invoices.items[].uid_out_of_service", "array-member-uncensusable"],
  ...
  ["orders.destinations[].exchange", "array-member-uncensusable"],
