...
const INERT_DEFAULTS: ReadonlySet<string> = new Set([
  ...
  "bookings.destinations.delivery.address.name",
  "bookings.destinations.delivery.address.postcode",
  "bookings.destinations.delivery.address.region",
  "bookings.destinations.delivery.address.street",
  "bookings.query_by_uid_location",
  ...
  "cards.dates.end",
  "cards.dates.start",
  "cards.destination.address.city",
  "cards.destination.address.country_name",
  "cards.destination.address.full",
  "cards.destination.address.name",
  "cards.destination.address.postcode",
  "cards.destination.address.region",
  "cards.destination.address.street",
  "cards.destination.contact.phones",
  "cards.locked",
  "cards.organization",
  "cards.uid_assignees",
  "comments.reactions",
  ...
  "credit-notes.items",
  "credit-notes.items[].description",
  "credit-notes.items[].price.base_cents",
  "credit-notes.items[].price.chargeable_days",
  "credit-notes.items[].price.discount",
  "credit-notes.items[].price.formula",
  "credit-notes.items[].price.subtotal_cents",
  "credit-notes.items[].price.subtotal_discounted_cents",
  "credit-notes.items[].price.taxes",
  "credit-notes.items[].price.total_cents",
  "credit-notes.items[].quantity",
  ...
  "credit-notes.organization.billing_address.city",
  "credit-notes.organization.billing_address.country_name",
  "credit-notes.organization.billing_address.full",
  "credit-notes.organization.billing_address.name",
  "credit-notes.organization.billing_address.postcode",
  "credit-notes.organization.billing_address.region",
  "credit-notes.organization.billing_address.street",
  "credit-notes.query_by_sources",
  "credit-notes.reference",
  "credit-notes.remaining_credit_cents",
  "credit-notes.sources",
  "credit-notes.totals.discount_amount_cents",
  "credit-notes.totals.subtotal_cents",
  "credit-notes.totals.subtotal_discounted_cents",
  "credit-notes.totals.taxes",
  "credit-notes.totals.total_cents",
  "credit-notes.xero_credit_note_id",
  "destinations.address.city",
  "destinations.address.country_name",
  "destinations.address.full",
  "destinations.address.name",
  ...
  "fulfillments.destinations[].delivery.address.name",
  "fulfillments.destinations[].delivery.address.postcode",
  "fulfillments.destinations[].delivery.address.region",
  "fulfillments.destinations[].delivery.address.street",
  "fulfillments.destinations[].delivery.contact.phones",
  "fulfillments.items",
  "fulfillments.items[]|0.description",
  "fulfillments.items[]|0.path",
  "fulfillments.items[]|0.quantity",
  "fulfillments.items[]|1.description",
  "fulfillments.items[]|1.name",
  "fulfillments.items[]|1.path",
  "fulfillments.items[]|2.description",
  "fulfillments.items[]|2.path",
  "fulfillments.query_by_contacts",
  "fulfillments.query_by_dates",
  "fulfillments.query_by_items",
  "fulfillments.reference",
  "holiday-definitions.active",
  "holiday-snapshot.materialized_dates",
  "inventory-ledgers.query_by_uid_location",
  "inventory-ledgers.query_by_uid_store",
  ...
  "invoices.items[]|0.price.base_cents",
  "invoices.items[]|0.price.chargeable_days",
  "invoices.items[]|0.price.discount",
  "invoices.items[]|0.price.formula",
  "invoices.items[]|0.price.subtotal_cents",
  "invoices.items[]|0.price.subtotal_discounted_cents",
  "invoices.items[]|0.price.taxes",
  "invoices.items[]|0.price.total_cents",
  "invoices.items[]|0.quantity",
  "invoices.items[]|1.description",
  "invoices.items[]|1.path",
  "invoices.items[]|2.description",
  "invoices.items[]|2.name",
  "invoices.items[]|2.path",
  "invoices.items[]|3.description",
  "invoices.items[]|3.name",
  "invoices.items[]|3.path",
  "invoices.number_orders",
  "invoices.organization.billing_address.city",
  "invoices.organization.billing_address.country_name",
  "invoices.organization.billing_address.full",
  "invoices.organization.billing_address.name",
  "invoices.organization.billing_address.postcode",
  "invoices.organization.billing_address.region",
  "invoices.organization.billing_address.street",
  "invoices.pdf_generated_at",
  "invoices.query_by_orders",
  "invoices.totals.amount_due_cents",
  "invoices.totals.amount_paid_cents",
  "invoices.totals.discount_amount_cents",
  "invoices.totals.subtotal_cents",
  "invoices.totals.subtotal_discounted_cents",
  "invoices.totals.taxes",
  "invoices.totals.total_cents",
  "invoices.totals.transaction_fees",
  ...
  "locations.products",
  "locations.query_by_product_capacities",
  "locations.query_by_products",
  "orders.bookings_breakdown",
  "orders.bookings_breakdown.damaged",
  "orders.bookings_breakdown.lost",
  "orders.bookings_breakdown.out",
  "orders.bookings_breakdown.prepped",
  "orders.bookings_breakdown.quoted",
  "orders.bookings_breakdown.reserved",
  "orders.bookings_breakdown.returned",
  "orders.destinations[].delivery.contact.phones",
  "orders.invoices",
  "orders.items",
  "orders.items[]|0.description",
  "orders.items[]|0.path",
  "orders.items[]|0.price.base_cents",
  "orders.items[]|0.price.chargeable_days",
  "orders.items[]|0.price.discount",
  "orders.items[]|0.price.formula",
  "orders.items[]|0.price.subtotal_cents",
  "orders.items[]|0.price.subtotal_discounted_cents",
  "orders.items[]|0.price.taxes",
  "orders.items[]|0.price.total_cents",
  "orders.items[]|0.quantity",
  "orders.items[]|1.description",
  "orders.items[]|1.name",
  "orders.items[]|1.path",
  "orders.items[]|2.description",
  "orders.items[]|2.path",
  "orders.organization.billing_address.city",
  "orders.organization.billing_address.country_name",
  "orders.organization.billing_address.full",
  "orders.organization.billing_address.name",
  "orders.organization.billing_address.postcode",
  "orders.organization.billing_address.region",
  "orders.organization.billing_address.street",
  "orders.query_by_contacts",
  "orders.query_by_dates",
  "orders.query_by_invoices",
  "orders.query_by_items",
  "orders.reference",
  "orders.totals.discount_amount_cents",
  "orders.totals.replacement_total_cents",
  "orders.totals.subtotal_cents",
  "orders.totals.subtotal_discounted_cents",
  "orders.totals.taxes",
  "orders.totals.total_cents",
  "orders.totals.transaction_fees",
  "orders.xero_id",
  "organizations.billing_address.city",
  "organizations.billing_address.country_name",
  "organizations.billing_address.full",
  "organizations.billing_address.name",
  "organizations.billing_address.postcode",
  "organizations.billing_address.region",
  "organizations.billing_address.street",
  "organizations.contacts[].roles",
  "organizations.emails",
  "organizations.phones",
  "organizations.query_by_contacts",
  "out-of-service.query_by_sources",
  "out-of-service.query_by_uid_location",
  "out-of-service.query_by_uid_store",
  "out-of-service.sources",
  ...
  "products.price.taxes",
  "products.webshop.available",
  "recurrences.prototype.attachments",
  "recurrences.prototype.attachments[].locked",
  "recurrences.prototype.body_text",
  "recurrences.prototype.destination.address.city",
  "recurrences.prototype.destination.address.country_name",
  "recurrences.prototype.destination.address.full",
  "recurrences.prototype.destination.address.name",
  "recurrences.prototype.destination.address.postcode",
  "recurrences.prototype.destination.address.region",
  "recurrences.prototype.destination.address.street",
  "recurrences.prototype.destination.contact.phones",
  "recurrences.prototype.locked",
  "recurrences.prototype.sources",
  "recurrences.prototype.uid_assignees",
  "roles.permissions",
  "stock.unavailable",
  "stores.default_location",
  "taxes.crms_id",
  "template-components.draft_uids",
  "templates-versions.consumed_components",
  "templates-versions.params",
  "templates.active_semver",
  "templates.depends_on.components",
  "templates.draft_uids",
  "templates.fixtures",
  "threads.last_message_preview",
  "transactions.cost.unit_costs_cents",
  "transactions.lines",
  "transactions.query_by_sources",
  "transactions.query_by_uid_location",
  "transactions.query_by_uid_store",
  ...
  "webshop-products.webshop.available",
]);
