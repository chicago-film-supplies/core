...
export { AnyUid, BookingId, CardId, EventCardId, FirestoreId, ItemUid, ListId, MovementId, QuoteId, RoleId, SEEDED_ROLE_NAMES, type SeededRoleName, ThreadId } from "./_uid.ts";
