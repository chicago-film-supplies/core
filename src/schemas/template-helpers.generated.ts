...
export const templateHelpers: Record<string, TemplateHelperEntry[]> = {
  ...
  "taxes": [
    ...
    { name: "deriveJurisdiction", expr: "it.taxes.deriveJurisdiction(address, origin)", desc: "**Where a delivery address sources to** — the bottom of the four-level jurisdiction precedence ({@link resolveJurisdiction}), below the document's own destination entry, the organization's `jurisdiction_claim` and the shared destination master.", returns: "JurisdictionType" },
