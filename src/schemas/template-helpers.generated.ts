...
export const templateHelpers: Record<string, TemplateHelperEntry[]> = {
  ...
  "invoices": [
    ...
    { name: "derivePaymentStatus", expr: "it.invoices.derivePaymentStatus(currentStatus, amountPaid, amountDue, arg4)", desc: "Derive invoice status from settlement amounts. Pure function — does not mutate the invoice.", returns: "InvoiceStatusType" },
    ...
    { name: "recomputeSettlementTotals", expr: "it.invoices.recomputeSettlementTotals(total, settlements)", desc: "Turn the settlements journal into the invoice's stored totals.", returns: "typeLiteral" },
  ],
  "locations": [
