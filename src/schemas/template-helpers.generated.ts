...
export const templateHelpers: Record<string, TemplateHelperEntry[]> = {
  ...
  "invoices": [
    ...
    { name: "calculateItemTotal", expr: "it.invoices.calculateItemTotal(item, taxes)", desc: "Calculate the total (subtotal_discounted + taxes) for a single line item.", returns: "number" },
  ...
  "orders": [
    ...
    { name: "calculateItemTotal", expr: "it.orders.calculateItemTotal(item, taxes)", desc: "Calculate the total (subtotal_discounted + taxes) for a single line item.", returns: "number" },
