...
export const templateHelpers: Record<string, TemplateHelperEntry[]> = {
  ...
  "fulfillments": [
    ...
    { name: "groupByDestination", expr: "it.fulfillments.groupByDestination(items, destinations)", desc: "Slice the flat items array into destination sections, each carrying the endpoints its PAIR names.", returns: "DestinationGroup[]" },
  ...
  "orders": [
    ...
    { name: "groupByDestination", expr: "it.orders.groupByDestination(items, destinations)", desc: "Slice the flat items array into destination sections, each carrying the endpoints its PAIR names.", returns: "DestinationGroup[]" },
