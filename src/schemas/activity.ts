 ...
 */
export const ACTIVITY_READ_PERMISSION_BY_COLLECTION: Readonly<
  Record<ActivitySubjectCollection, Permission>
> = {
  "cards": "cards.read",
  ...
  "tags": "tags.read",
  "taxes-classes": "taxClasses.read",
  "taxes-codes": "taxCodes.read",
  "taxes-rates": "taxRates.read",
  // NOT `templateComponents.read` — components share the family's permission.
  "template-components": "templates.read",
  "templates": "templates.read",
  "threads": "threads.read",
  "tracking-categories": "trackingCategories.read",
 ...
 */
export function activityFeedPermissionsFor(held: Iterable<Permission>): Permission[] {
  const mine = held instanceof Set ? held : new Set(held);
  return ACTIVITY_FEED_PERMISSIONS.filter((p) => mine.has(p));
}
