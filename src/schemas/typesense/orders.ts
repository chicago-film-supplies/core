...
export const orders: TypesenseCollectionConfig = {
  ...
  schema: {
    ...
    fields: [
      ...
      { name: "totals.discount_amount_cents", type: "int64", optional: true, money: true },
      { name: "totals.subtotal_cents", type: "int64", optional: true, money: true },
      { name: "totals.subtotal_discounted_cents", type: "int64", optional: true, money: true },
      ...
      { name: "totals.taxes.amount_cents", type: "int64[]", optional: true, money: true },
      ...
      { name: "totals.transaction_fees.amount_cents", type: "int64[]", optional: true, money: true },
      ...
      { name: "items.total_price_cents", type: "int64[]", optional: true, money: true },
      ...
      { name: "items.price.subtotal_discounted_cents", type: "int64[]", optional: true, money: true },
      { name: "items.price.total_cents", type: "int64[]", optional: true, money: true },
      ...
      { name: "items.price.discount.amount_cents", type: "int64[]", optional: true, money: true },
      ...
      { name: "items.price.taxes.amount_cents", type: "int64[]", optional: true, money: true },
      { name: "items.price.chargeable_days", type: "int32[]", optional: true },
      { name: "items.price.replacement_cents", type: "int64[]", optional: true, money: true },
