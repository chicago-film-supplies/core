...
export const orders: TypesenseCollectionConfig = {
  ...
  schema: {
    ...
    fields: [
      ...
      { name: "totals.discount_amount", type: "float", optional: true, money: true },
      { name: "totals.subtotal", type: "float", optional: true, money: true },
      { name: "totals.subtotal_discounted", type: "float", optional: true, money: true },
      ...
      { name: "totals.taxes.amount", type: "float[]", optional: true, money: true },
      ...
      { name: "totals.transaction_fees.amount", type: "float[]", optional: true, money: true },
      ...
      { name: "items.total_price", type: "float[]", optional: true, money: true },
      { name: "items.price", type: "object[]", optional: true },
      { name: "items.price.base", type: "float[]", optional: true, money: true },
      { name: "items.price.subtotal", type: "float[]", optional: true, money: true },
      { name: "items.price.subtotal_discounted", type: "float[]", optional: true, money: true },
      { name: "items.price.total", type: "float[]", optional: true, money: true },
      ...
      { name: "items.price.discount.amount", type: "float[]", optional: true, money: true },
      ...
      { name: "items.price.taxes.amount", type: "float[]", optional: true, money: true },
      { name: "items.price.chargeable_days", type: "int32[]", optional: true },
      { name: "items.price.replacement", type: "float[]", optional: true, money: true },
