...
export const products: TypesenseCollectionConfig = {
  ...
  schema: {
    ...
    fields: [
      ...
      { name: "price.base", type: "float", optional: true, money: true },
      { name: "price.replacement", type: "float", optional: true, money: true },
      ...
      { name: "components.price.base", type: "float[]", optional: true, money: true },
      { name: "components.price.replacement", type: "float[]", optional: true, money: true },
      ...
      { name: "component_of.price.base", type: "float[]", optional: true, money: true },
      { name: "component_of.price.replacement", type: "float[]", optional: true, money: true },
