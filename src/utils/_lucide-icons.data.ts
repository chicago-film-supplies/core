// AUTO-GENERATED by scripts/generate-lucide-icons.ts — do not edit manually.
//
// Source: lucide-static@1.31.0 (ISC) — https://lucide.dev/license
 ...
 */
export const LUCIDE_ICON_DATA: string = `a-arrow-down	<path d="m14 12 4 4 4-4"/><path d="M18 16V7"/><path d="m2 16 4.039-9.69a.5.5 0 0 1 .923 0L11 16"/><path d="M3.304 13h6.392"/>
